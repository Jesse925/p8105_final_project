...
###  Volin plot: Gender difference in drug-related deaths {.tabset}
...
###  Spaghetti plot: No. of death vs. Time {.tabset}
...
###  Bubble plot: No. of death vs. Month (group by types of drug) {.tabset}
