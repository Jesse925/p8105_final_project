...
levels(pull(V_plot,drug))

levels(V_plot$drug) = c("amphet","opioid","benzodiazepine","cocaine", "ethanol" ,      "fentanyl&analogue","fentanyl&analogue","heroin","hydrocodone",        
"hydromorphone" ,"methadone" ,"morphine_not_heroin",
"opioid", "other","oxycodone","oxymorphone","tramad")
