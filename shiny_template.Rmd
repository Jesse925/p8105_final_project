...
```{r}
pal <- colorFactor(c("brown", "black"), domain = c(1:2, 3:8))
...
renderLeaflet({
    ...
    addCircleMarkers(
      ...
      popup = paste(
        new_drug_df$drug_names
      )
    )
  })

# below is for testing without runing the whole document again

# pal <- colorFactor(c("red", "black"), domain = c(1:2, 3:8))
# 
...
```
>>>>>>> 5eb443c004829f80280edd08ed09773102a4151a
