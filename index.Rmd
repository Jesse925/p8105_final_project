...
This website is for our data science final project, in which we analyzed the data that contain lists of accidental death associated with drug use in Connecticut from 2012 to 2018. 
...
The dataset contains a listing of accidental death associated with drug overdose in Connecticut from 2012 to 2018. It twas obtained from an investigation by the Office of the Chief Medical Examiner which includes the toxicity report, death certificate, as well as a scene investigation. 
